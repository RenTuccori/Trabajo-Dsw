...
function AdministrationHome() {
  ...
  const tiles = [
    { path: '/admin/createPatient', label: 'Pacientes', desc: 'Gestioná los pacientes del sistema', color: 'brand', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },

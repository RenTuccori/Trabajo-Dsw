    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white flex flex-col items-center justify-center p-6">
            <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6 space-y-4">
                <h1 className="text-2xl font-bold text-blue-800 text-center">Turno creado</h1>
                ...
                <p className="text-sm text-gray-600 text-center mt-4">
                    Si no recibiste el correo de confirmación, por favor verifica tu dirección de correo en la sección de <strong>Datos Personales</strong> y asegúrate de que sea correcta.
                </p>
            </div>

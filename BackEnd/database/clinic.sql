...
CREATE TABLE `doctors` (
  ...
  CONSTRAINT `doctors_ibfk_1` FOREIGN KEY (`national_id`) REFERENCES `users` (`national_id`)
...
CREATE TABLE `studies` (
  ...
  CONSTRAINT `studies_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`),
  CONSTRAINT `studies_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `available_schedules` (
  ...
  `status` varchar(45) NOT NULL,
  PRIMARY KEY (`day`,`start_time`,`end_time`,`location_id`,`doctor_id`,`specialty_id`),
  KEY `location_id` (`location_id`),
  KEY `doctor_id` (`doctor_id`),
  KEY `specialty_id` (`specialty_id`),
  CONSTRAINT `available_schedules_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `available_schedules_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`),
  CONSTRAINT `available_schedules_ibfk_3` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `health_insurances` VALUES (1,'Particular','Habilitado'),(2,'OSDE','Habilitado'),(3,'Swiss Medical','Habilitado'),(4,'Galeno','Habilitado'),(5,'PAMI','Habilitado');
...
CREATE TABLE `patients` (
  ...
  PRIMARY KEY (`id`),
  KEY `national_id` (`national_id`),
  CONSTRAINT `patients_ibfk_1` FOREIGN KEY (`national_id`) REFERENCES `users` (`national_id`)
...
--
-- Table structure for table `doctor_specialty_locations`
--

DROP TABLE IF EXISTS `doctor_specialty_locations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `doctor_specialty_locations` (
  `location_id` int NOT NULL,
  `doctor_id` int NOT NULL,
  `specialty_id` int NOT NULL,
  `status` varchar(45) NOT NULL,
  PRIMARY KEY (`location_id`,`doctor_id`,`specialty_id`),
  KEY `specialty_id` (`specialty_id`),
  KEY `doctor_id` (`doctor_id`),
  CONSTRAINT `doctor_specialty_locations_ibfk_1` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`id`),
  CONSTRAINT `doctor_specialty_locations_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `doctor_specialty_locations_ibfk_3` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `doctor_specialty_locations`
--

LOCK TABLES `doctor_specialty_locations` WRITE;
/*!40000 ALTER TABLE `doctor_specialty_locations` DISABLE KEYS */;
INSERT INTO `doctor_specialty_locations` VALUES (1,1,1,'Habilitado'),(1,1,4,'Habilitado'),(2,2,3,'Habilitado'),(3,2,5,'Deshabilitado');
/*!40000 ALTER TABLE `doctor_specialty_locations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `appointments` (
  ...
  KEY `doctor_id` (`doctor_id`),
  KEY `location_id` (`location_id`),
  CONSTRAINT `appointments_ibfk_1` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`id`),
...
CREATE TABLE `users` (
  ...
  KEY `health_insurance_id` (`health_insurance_id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`health_insurance_id`) REFERENCES `health_insurances` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

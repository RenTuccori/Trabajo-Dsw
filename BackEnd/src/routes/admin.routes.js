...
import { getAdmin, createSeEspDoc, deleteSeEspDoc, getCombinaciones, createHorarios, getHorariosXDoctor, updateHorarios } from "../src/controllers/admin.controllers.js";
import { createDoctor, deleteDoctor, updateDoctor } from "../src/controllers/doctores.controllers.js";
import { createSede, updateSede, deleteSede } from "../src/controllers/sedes.controllers.js";
import { createObraSocial, getObrasSociales, deleteObraSocial, updateObraSocial } from "../src/controllers/obrassociales.controller.js";
import { createSpecialty, deleteSpecialty } from "../src/controllers/especialidades.controllers.js";
const router = Router();

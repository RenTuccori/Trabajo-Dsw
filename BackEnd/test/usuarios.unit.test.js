...
describe('Users Controller – Unit Tests', () => {
  ...
  beforeEach(() => {
    req = { body: {}, params: {}, session: { role: 'Patient' } };
    res = {
      json: jest.fn(),
  ...
  // ── getUserByNationalIdPassword (auth) ───────────────────────────
  describe('getUserByNationalIdPassword', () => {
    it('should return a JWT token for valid credentials', async () => {
      req.body = { nationalId: 11111111, password: 'pass123' };
      mockService.authenticatePatient.mockResolvedValue({ token: 'fake.jwt.token' });

      await getUserByNationalIdPassword(req, res);

      expect(mockService.authenticatePatient).toHaveBeenCalledWith(11111111, 'pass123');
  ...
  describe('createUser', () => {
    it('should create a user and return 201', async () => {
      const body = { nationalId: 33333333, firstName: 'New' };
      req.body = body;
  ...
  describe('updateUser', () => {
    it('should update user and return updated data', async () => {
      req.body = { nationalId: 11111111, firstName: 'Updated' };
      mockService.updateExistingUser.mockResolvedValue({ nationalId: 11111111, firstName: 'Updated' });

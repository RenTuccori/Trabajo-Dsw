...
export const createUser = async (req, res) => {
  const { nombre, apellido, dni, fechaNac, sexo, telefono, mail } = req.body;
  try {
    await pool.query(
      'INSERT INTO usuarios (nombre, apellido, dni,fechaNac, sexo, telefono, mail) VALUES (?, ?, ?, ?, ?, ?, ?)',
      [nombre, apellido, dni, fechaNac, sexo, telefono, mail]
    );
    res.json({
      nombre,
      apellido,
